...
export async function seedProducts() {
  ...
  const products = [
    ...
    },
    {
      ...
      name: "SUPPLY OF REQUIRED TOOLS AND MATERIALS FOR CLEANING AFTER GROUTING ETC.",
      ...
      templateText: "SUPPLY OF REQUIRED TOOLS AND MATERIALS FOR CLEANING AFTER GROUTING ETC.:\n\nLabour charges for Tiles fixing & Epoxy Grouting",
      templateVariables: [],
      imagePath: "/templates/mr-swimming-pools/part2/tile-fixing-cleaning-tools.jpg",
      sortOrder: 29,
    },
    {
